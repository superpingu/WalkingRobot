module.exports = (robot) ->
    ...
    robot.knee.preset 'middle', position: 0

    robot.leg.speed(20)
    robot.leg.torque(50)
    robot.leg.preset 'down', position: 0
    ...
    robot.kneeFL.preset 'forward', position: 0
    robot.kneeFR.preset 'forward', position: 0
    robot.kneeRL.preset 'forward', position: 0
    robot.kneeRR.preset 'forward', position: 0
    ...
    robot.kneeFL.preset 'backward', position: 0
    robot.kneeFR.preset 'backward', position: 0
    robot.kneeRL.preset 'backward', position: 0
    robot.kneeRR.preset 'backward', position: 0
